...
const Styles = styled.span`
	...
	& > svg:hover > .svg-path {
		cursor: pointer;
		fill: ${colorSystem.darkPink};
		color: ${colorSystem.darkPink};
	}
`;

const Icons: React.FC<{ type: 'facebook' | 'twitter' | 'linkedin' }> = ({
	type,
}) => {
	//? You need to add to the path the classname ".svg-path" to add the hover effect
	if (type === 'facebook')
		return (
			<Styles>
